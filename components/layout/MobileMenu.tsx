    ...
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-gray-900 border-b border-gray-800 z-50">
        <div className="flex items-center justify-between p-4">
          <div>
            <h1 className="text-xl font-bold text-white">XLO System</h1>
          </div>
          <button
      ...
      {/* Mobile Menu */}
      <div
        className={`lg:hidden fixed top-0 right-0 h-full w-80 bg-gray-900 border-l border-gray-800 z-50 transform transition-transform duration-300 ${
